...
```{r, echo=TRUE}
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# TFDEA 0.9.8.3 (December 2022) generates an error
#     Error in `dmu.status2 != 0 || dmu.status2 != NA`:
#     !'length = 19' in coercion to 'logical(1)'
# Set to eval=FALSE
# Update to 0.9.8.4 using Auro's fork
# library(devtools);devtools::install_github("aurokp2/TFDEA_V2")
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
```

```{r run-tfdea, eval=TRUE}
...
```{r examine-pre1960-results, eval=TRUE}
...
```{r examine-post1960-results, eval=TRUE}
