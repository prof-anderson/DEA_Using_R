...
colnames(collectedeff1)<-c("CCRIO", "CCRIOWR")
pander(head(collectedeff1))
ggplot (collectedeff1, aes(x=CCRIO, y=CCRIOWR)) +
        xlab("CCRIO Efficiency") + 
        ylab("CCRIO Efficiency with Weight Restrictions") +
...
#pander(head(collectedeff, caption="Table of collected eff for ggplot debug"))
