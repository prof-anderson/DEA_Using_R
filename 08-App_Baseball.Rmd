...
colnames(collectedeff1)<-c("Efficiency", "Efficiency/WR", 
                           "Cross-Efficiency", "Cross-Efficiency/WR")
...
Both the simple Pearson's correlation matrix and the Spearman's rank correlation matrix give similar scores but the Spearman rank correlations are generally higher. This indicates that the scores for the `r nrow(res1920ALmult$Efficiency)` players are numerically related and their relative ranking is a little more similar.  
...
kbl(poscol(cbind(res1991MLB$eff,res1991MLB$lambda)), 
    booktabs=T, digits=4, 
       caption=
         "VRS Efficiency and Lambda Values of 1991 AL Teams") |>
kable_styling(latex_options = c("hold_position", "scale_down"))
```
...
kbl (head(teampayroll3), booktabs=T, digits=2,
     caption="Team Information") |>
  kable_styling (latex_options = c("hold_position", "scale_down"))
                 
kbl (head(cbind(teampayroll2$Efficiency, 
                  teampayroll3$Efficiency)), booktabs=T, digits=2, 
       caption=
