...
\begin{aligned}
  ...
  \end{aligned}
\end{split}$$ Given the one input, five output case, we could write an explicit linear program as the following for each player *k*.
...
```{r, fig.show='hold', fig.align='center', out.width="70%",fig.cap="Impact of Weight Restrictions on Efficiency"}
...
```{r, echo=FALSE, fig.show='hold', fig.align='center', out.width="70%", fig.cap="Cross-Efficiency vs. Efficiency"}
...
```{r, echo=FALSE, fig.show='hold', out.width="70%", fig.align='center', fig.cap="Impact of Weight Restrictions on Cross-Efficiency"}
