...
As industries become ever more global and more competitive, it is critical to do things in the best way possible. Even organizations that have been successful for decades need to keep their competitive edge and avoid getting complacent. This results in a search for best practices. What was a best practice ten years ago, may no longer be best practice. Quantitative benchmarking can be done to provide objective targets and narrow the realm of possibilities from whom to learn about best practices.
...
R has rapidly become a standard tool for analytics due to its open source nature, extensability, and being built with statistical analysis in mind. Like other powerful tools, it has a bit of a learning curve but getting started may be more approachable than in general purpose programming languages. There are many excellent books on R. Two of my favorite classics are: *R in Action* [@AdlerNutshell2012] and *The Art of R Programming* [@MatloffArtprogramming2011].
