...
While all R code used in this book runs, it is written from the perspective of demonstration and documentation. \index{Data envelopment analysis!problems} DEA problems are generally not very computationally demanding unless thousands or tens of thousands of units are being analyzed so computational efficiency is not emphasized.
...
Peter Bogetoft and Lars Otto have written a very thorough book on DEA and other econometric methods, \index{Benchmarking} *Benchmarking with DEA, SFA, and R* [@BogetoftBenchmarkingDEASFA2011]. It is equal parts a mathematical book on frontier estimation and a manual for their R DEA package, `Benchmarking`. It is an excellent book. We will revisit this and other packages later book presumes some basic familiarity with R.
