...
In the case of a store being benchmarked against similar stores in the same chain, changes due to general operating conditions might be due to inflation raising wages (or materials, end products, etc.), or changing laws or regulations. In this situation, a change in the general operating conditions is like "...a rising tide raising all boats." It is good to identify and quantify these impacts, but it isn't something that an individual store manager would be either blamed for performance loss due to this or praised for changes helping. Stock traders highlight the importance of this issue---making a 20% return when the market is also up 20% is not particularly impressive and getting a 15% return might be considered poor.
...
```{r displaymalm1, echo=FALSE, out.width="55%", fig.show='hold', fig.align='center', fig.cap="Malmquist Graphical Example"}
...
```{r displaymalm4, echo=FALSE, out.width="55%", fig.show='hold', fig.align='center', fig.cap="Detailed Graphical Example of Malmquist"}
...
Ty Cobb's values are interesting. His value for *E19-T19* is *1* and therefore he was efficient in 1919 using his 1919 batting statistics. He is no longer efficient in 1920 as indicated by *E20-T20* being *0.9165.* While his 1919 performance was efficient relative to 1919, it would not have been efficient against the frontier in 1920 (E19-T20 \< 1.0). The *TC* value indicates that his efficiency declined relative to their respective efficiency frontiers. The TEC value, though, is larger than 1 indicating that the efficiency frontier expanded relative to the regions of the frontier that Ty Cobb was producing. If we had been looking at the managerial performance of DMUs instead of batting performance of hitters, we would say that Ty Cobb was not as efficient in using his input to produce outputs relative to the changing efficiency frontier. The efficiency frontier expanded and Ty Cobb fell off the efficiency frontier.
