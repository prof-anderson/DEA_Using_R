...
This indicates that about 46% of the unit's improved perfmorance is due to the general progress of technology or improving operating conditions (rising tide effect).
...
Let's now take a look at conducting the analysis using the `deaR` package.
...
kbl(head(res_bb 
         [order(res_bb[,3], decreasing=TRUE),],20), digits=5, booktabs=T,
...
kbl(head(cbind(y19, my19)), booktabs=T,
  ...
  add_header_above( c(" " = 1, "Original Outputs" = 5, "Modified Outputs" = 5)) |>
 kable_styling(latex_options = c("hold_position")) |>
