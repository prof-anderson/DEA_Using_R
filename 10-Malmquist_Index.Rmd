...
The results match those from those found along the way in the Malmquist analysis but do not agree with those from earlier. Let's unpack the weights given the structure of
