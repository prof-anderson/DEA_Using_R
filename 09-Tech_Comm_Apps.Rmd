...
In 2002, Sten Thore edited the book, *Technology Commercialization: DEA and Related Analytical Methods for Evaluating the Use and Implementation of Technological Innovation* The book compiled a series of cases applying Data Envelopment Analysis to real-world technology management situations.
...
Again, the results match those of Thore and Rich. Their discussion of results emphasized the comparison of projects by examining the lambda values to see how the targets of comparison were made.
