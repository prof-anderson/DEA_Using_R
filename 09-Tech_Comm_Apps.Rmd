...
Now, let's install some small helper functions.  These are described in more detail in a later chapter.
...
Figure<-DrawIOdiagram(Xnames,Ynames)
tmp<-capture.output(rsvg_png(charToRaw(export_svg(Figure)),'IO-BakerHughes.png'))

```

![Bake Hughes Input-Output Model](IO-BakerHughes.png){#fig:IO-BakerHughes}
