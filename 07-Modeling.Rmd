...
One way to approach DEA modeling is to examine a series of questions. "What is the goal of the analysis?" A DEA evaluation can be used in a variety of ways but it is important decide on a goal to lead the rest of the modeling. Goals include but are not limited to evaluating management, setting targets, and determining best practices.
