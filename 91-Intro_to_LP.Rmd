...
The first line creates the basic model.  The piple symbol at the end of each line basically means add the next item to the previous so we can build up the model quickly.  
