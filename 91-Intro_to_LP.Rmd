...
pander(cduals0,caption="Incorrect Reduced Costs of Variables")
```
...
dimnames(cduals0)<-list(sort(c("Desks", "Tables", "Bookcases")), c("Column Duals"))
pander(cduals0,caption="Correct Reduced Costs of Variables")
```

More testing is needed to confirm that this issue is cause by alphabetizing the variables (columns).  
