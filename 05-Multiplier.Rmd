...
Let's turn our attention instead to intuitively developing the DEA multiplier model through a simple scoring ratio.
...
* Better table headings drawn from chapter 2 work
