...
This isn't a linear program because we are dividing functions of variables by functions of variables. We need to make a few transformations. First, we clear the denominator of each of the consraints and collect the terms on resulting in the following formulation.
