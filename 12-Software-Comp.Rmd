...
kbl (res_nonparaeff$eff, caption="Efficiency Scores from nonparaeff",
     booktabs = T, digits = 4)
...
kbl (res_rDEA$lambda, caption="Lambda Results from Benchmarking",
     booktabs = T, digits = 4)
...
kbl(res_MultiplierDEA$Efficiency, 
       caption="Efficiency Scores from multiplierDEA", 
    booktabs = T, digits = 4)

kbl (res_MultiplierDEA$Lambda, 
...
kbl (combined_eff, caption = "Comparison of Efficiency Scores",
     booktabs = T, digits = 6)      
