...
```{r package_download_stats, echo=TRUE, eval=FALSE}

#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# Temporarily disabled to skip a breaking error:
#           [Kdlstats: fetching data for 2021-01
...
# Clean all character columns to ensure valid UTF-8
# This "cleaning" did not fix the problem.
pkg_dl_data[] <- lapply(pkg_dl_data, function(x) {
  if(is.character(x)) stringi::stri_enc_toascii(x) else x
})

```


```{r plot_dea_package_use, echo=TRUE, eval=FALSE}
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# Temporarily disabled to skip a breaking error:
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
