...
pander(res_benchmarking$eff, caption="Efficiency Scores from Benchmarking")

pander(res_benchmarking$lambda, caption="Lambda Variable Results from Benchmarking")
...
pander(t(rbind(res_nonparaeff$lambda1,
       ...
       caption="Lambda Variable Results from nonparaeff")
