...
```{r, echo=FALSE}
rownames(ceTT03$ce_ave)<-"Single-Phase Cross-Efficiency"
rownames(ceTT03mal$ce_ave)<-"Malevolent Cross-Efficiency"
rownames(ceTT03ben$ce_ave)<-"Benevolent Cross-Efficiency"

kbl (rbind(t(cbind(XTT03, YTT03)),
             ceTT03$ce_ave, ceTT03mal$ce_ave, ceTT03ben$ce_ave), 
           booktabs = T, digits=5,
