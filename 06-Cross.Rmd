...
kbl (result$ce_ave, align = c, caption="Cross-Efficiency Scores", booktabs = T, digits = 4)
...
kbl (results.crosseval, caption = "Cross-evaluation Matrix", booktabs = T)

#for (j in 1:ND) {results.crosseff[j]<-sum(results.crosseval[,j])/ND}
kbl (results.crosseff, caption = "Cross-Efficiency Results", booktabs = T)
...
kbl (rbind(rescross$crosseval,t(rescross$crosseff)), 
             caption="Cross-Evaluation Matrix and Cross-Evaluation Scores", booktabs = T)
...
kbl (cbind(XTT03, YTT03), 
        caption = "Input-Output Data for Takamura and Tone, 2003", booktabs = T)
```
