...
Another question is how to construct the target for *B*'s evaluation. The target is simply made by scaling down *C* to a third of its original size. This results in a target that is composed of about 0.333 of *C* and none of *A*, *B*, or *D*.
