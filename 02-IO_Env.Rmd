...
Furthermore, the results in the table indicate that DMU _B_ has an efficiency score of 50%.  The target of performance is made of DMU _C_ scaled down by a factor of 0.33. These results match the graphical results from earlier.
...
pander (cbind(results.efficiency, results.lambda),round=6, 
