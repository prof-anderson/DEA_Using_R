...
We can call get a summary of our status of building up the `mod2_0` linear program model by just entering `mod2_0` object.
...
```{r}
kbl(res2_0$solution, digits=3,booktabs=T, escape=F,
