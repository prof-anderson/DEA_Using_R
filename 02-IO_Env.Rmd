...
-   The piped commands are like glue connecting two commands together so you don't want to end with another pipe that expects a different object.
...
-   The piping operator, `|>`, introduced by the `magrittr`package and then adopted by `dplyr`has become so popular that it was added to the core `R` system in version 4.1 (mid 2021).
