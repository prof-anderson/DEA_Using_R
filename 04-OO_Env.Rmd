...
-   The \index{TRA!poscol} `poscol` function from the \index{TRA} `TRA` package was used with a `cutoff` value to eliminate columns of $\lambda$ for inefficient units.
