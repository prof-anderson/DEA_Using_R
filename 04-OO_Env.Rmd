...
The results in the table interesting.  

- The measures of $\rho$ are relatively robust and consistent with the efficiency scores.
- For the slack based models, changing the measures from maximizing slacks to slack percentages changed the targets ($\lambda$ values) not the holistic overall score of $\rho$.  This is unlikely to persist in more complex models.
