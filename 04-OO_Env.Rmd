...
This tells us that unit C is the only output-oriented CCR efficient unit.  

Now, let us try looking at this another way.  Let's see if we can extract the dual weights for the inputs and outputs.  