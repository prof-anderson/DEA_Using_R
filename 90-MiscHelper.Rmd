...
#tmp<-capture.output(rsvg_png(charToRaw(export_svg(demoIOdiagram)),'demoIOdiagram'))
tmp<-capture.output(rsvg_png(charToRaw(export_svg(demoIOdiagram)),'demoIOdiagram.png'))

#cat('![Demonstration of IO Diagram](demoIOdiagram.png){#fig:demoIOdiagram}\n\n')

#![diagram] (demoIOdiagram.png)

include_graphics('demoIOdiagram.png')
