...
t1 <- cbind (x,y)
t2 <- cbind (x,y)
rownames(t2) <- modelnames$DMUnames[[1]]
colnames(t2) <- c(modelnames$Xnames[[1]], modelnames$Ynames[[1]])
t3 <- cbind (x,y)
rownames(t3) <- modelnames$DMUnames[[1]]
colnames(t3) <- c(modelnames$XnamesLX[[1]], modelnames$YnamesLX[[1]])
```
