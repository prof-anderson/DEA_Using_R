...
In theory, a cutoff could be set to exactly zero but sometimes small deviations from zero will arise from floating point arithmetic calculation. A cutoff value can then be used to guard against these very small positive or negative values when the result should actually be zero.
